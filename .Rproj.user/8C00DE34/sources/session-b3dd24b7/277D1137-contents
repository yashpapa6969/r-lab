...
# Determine the number of unique teams that have participated in IPL
matches
...
barplot(Matches_won_by_team, main = "Number of Matches Won by Each
Team", xlab = "Team", ylab = "Wins", col = rainbow(n_teams))